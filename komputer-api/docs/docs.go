        ...
        "/agents/{name}/ws": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Consumer group name. When set, this connection joins a group and Redis-coordinated single-delivery applies.",
                        "name": "group",
                        "in": "query"
                    }
                ],
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/main.UpdateConnectorRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/main.SquadListResponse"
                        }
                    },
                    "500": {
                        "description": "Internal error",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/main.CreateSquadRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/main.PatchSquadRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/main.AddSquadMemberRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "main.AddSquadMemberRequest": {
            ...
            "properties": {
                ...
                "spec": {
                    "$ref": "#/definitions/v1alpha1.KomputerAgentSpec"
                }
            }
        },
        ...
        "main.CreateAgentRequest": {
            ...
            "properties": {
                ...
                "priority": {
                    "description": "queue priority; higher = admitted first",
                    "type": "integer"
                },
                "role": {
        ...
        "main.CreateScheduleRequest": {
            ...
            "properties": {
                "agent": {
                    "$ref": "#/definitions/v1alpha1.ScheduleAgentSpec"
                },
                "agentName": {
                    "type": "string"
                },
        ...
        "main.CreateSquadRequest": {
            ...
            "properties": {
                "members": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/v1alpha1.KomputerSquadMember"
                    }
                },
                "name": {
                    "type": "string"
        ...
        "main.PatchAgentRequest": {
            ...
            "properties": {
                ...
                "priority": {
                    "description": "pointer so 0 vs unset is distinguishable",
                    "type": "integer"
                },
                "secretRefs": {
        ...
        "main.SquadResponse": {
            ...
            "properties": {
                ...
                "members": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/main.SquadMemberResponse"
                    }
                },
                "message": {
                    "type": "string"
        ...
        "main.UpdateConnectorRequest": {
            ...
            "properties": {
                ...
                "token": {
                    "description": "new auth token; replaces the value in the connector's secret",
                    "type": "string"
                }
            }
        },
        ...
        "v1alpha1.KomputerAgentSpec": {
            ...
            "properties": {
                ...
                "instructions": {
                    "description": "Instructions is the user's task for the Claude agent.",
                    "type": "string"
                },
                ...
                "memories": {
                    "description": "Memories is a list of KomputerMemory names to attach to this agent.\nNames can be \"name\" (same namespace) or \"namespace/name\" (cross-namespace).\n+optional",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
                ...
                "skills": {
                    "description": "Skills is a list of KomputerSkill names to attach to this agent.\nNames can be \"name\" (same namespace) or \"namespace/name\" (cross-namespace).\n+optional",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
        ...
        "v1alpha1.KomputerSquadMemberRef": {
            "type": "object",
            "properties": {
                "name": {
                    "type": "string"
                ...
                "namespace": {
                    "description": "defaults to squad's namespace",
                    "type": "string"
                }
            }
        },
        "v1alpha1.ScheduleAgentSpec": {
            "type": "object",
            "properties": {
                "allowedTools": {
                    "description": "AllowedTools restricts the agent to exactly these tools. When empty, the\ndefault built-in tool set is used and all tools from attached connectors\nare permitted.\n\nSetting this REPLACES the default set rather than extending it, so an\nagent given only [\"Read\"] loses Bash, Write, Edit and the rest. Connector\ntools are not auto-added either — list them explicitly, e.g.\n\"mcp__figma__*\" for a whole connector or \"mcp__figma__get_design_context\"\nfor a single tool.\n+optional",
        ...
        "v1alpha1.StorageSpec": {
            ...
            "properties": {
                "size": {
                    "description": "Size is the PVC storage size (e.g. \"5Gi\").\n+kubebuilder:default=\"5Gi\"",
                    "type": "string"
                },
                "storageClassName": {
                    "description": "StorageClassName is the optional storage class name.\n+optional",
                    "type": "string"
                }
            }
        }
