...
export const CONNECTOR_TEMPLATES: ConnectorTemplate[] = [
  ...
  },
  {
    ...
    authPlaceholder: "",
    guideSteps: [
      "Google Workspace MCP integration coming soon.",
      "In the meantime, you can self-host github.com/taylorwilsdon/google_workspace_mcp and add it as a custom connector.",
    ],
    color: "#EA4335",
  ...
  },
  {
    ...
    guideSteps: [
      ...
      "Name it, select a workspace, and choose capabilities",
