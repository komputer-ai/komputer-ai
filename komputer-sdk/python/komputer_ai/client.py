...
class KomputerClient:
    ...
    def create_agent(self, name: str, instructions: str, *, allowed_tools: Optional[List[str]] = None, connectors: Optional[List[str]] = None, disallowed_tools: Optional[List[str]] = None, lifecycle: Optional[str] = None, memories: Optional[List[str]] = None, model: Optional[str] = None, namespace: Optional[str] = None, office_manager: Optional[str] = None, pod_spec: Optional[V1PodSpec] = None, priority: Optional[int] = None, role: Optional[str] = None, secret_refs: Optional[List[str]] = None, skills: Optional[List[str]] = None, storage: Optional[V1alpha1StorageSpec] = None, system_prompt: Optional[str] = None, template_ref: Optional[str] = None):
        try:
            return self.agents.create_agent(CreateAgentRequest(allowed_tools=allowed_tools, connectors=connectors, disallowed_tools=disallowed_tools, instructions=instructions, lifecycle=lifecycle, memories=memories, model=model, name=name, namespace=namespace, office_manager=office_manager, pod_spec=pod_spec, priority=priority, role=role, secret_refs=secret_refs, skills=skills, storage=storage, system_prompt=system_prompt, template_ref=template_ref))
        except ApiException as e:
            if e.status == 409:
                return self.patch_agent(name, allowed_tools=allowed_tools, connectors=connectors, disallowed_tools=disallowed_tools, instructions=instructions, lifecycle=lifecycle, memories=memories, model=model, pod_spec=pod_spec, priority=priority, secret_refs=secret_refs, skills=skills, storage=storage, system_prompt=system_prompt, template_ref=template_ref)
            raise

    def get_agent(self, name: str):
        return self.agents.get_agent(name)

    def patch_agent(self, name: str, *, allowed_tools: Optional[List[str]] = None, connectors: Optional[List[str]] = None, disallowed_tools: Optional[List[str]] = None, instructions: Optional[str] = None, lifecycle: Optional[str] = None, memories: Optional[List[str]] = None, model: Optional[str] = None, pod_spec: Optional[V1PodSpec] = None, priority: Optional[int] = None, secret_refs: Optional[List[str]] = None, skills: Optional[List[str]] = None, storage: Optional[V1alpha1StorageSpec] = None, system_prompt: Optional[str] = None, template_ref: Optional[str] = None):
        return self.agents.patch_agent(name, PatchAgentRequest(allowed_tools=allowed_tools, connectors=connectors, disallowed_tools=disallowed_tools, instructions=instructions, lifecycle=lifecycle, memories=memories, model=model, pod_spec=pod_spec, priority=priority, secret_refs=secret_refs, skills=skills, storage=storage, system_prompt=system_prompt, template_ref=template_ref))
