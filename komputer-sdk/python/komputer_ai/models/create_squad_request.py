...
class CreateSquadRequest(BaseModel):
    ...
    CreateSquadRequest
    """ # noqa: E501
    members: List[V1alpha1KomputerSquadMember]
    name: StrictStr
    namespace: Optional[StrictStr] = None
    orphan_ttl: Optional[StrictStr] = Field(default=None, description="duration string e.g. \"10m\"", alias="orphanTTL")
    __properties: ClassVar[List[str]] = ["members", "name", "namespace", "orphanTTL"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "members": [V1alpha1KomputerSquadMember.from_dict(_item) for _item in obj["members"]] if obj.get("members") is not None else None,
            "name": obj.get("name"),
            "namespace": obj.get("namespace"),
            "orphanTTL": obj.get("orphanTTL")
        })
        return _obj
