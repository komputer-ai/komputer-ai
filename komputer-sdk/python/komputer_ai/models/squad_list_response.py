...
class SquadListResponse(BaseModel):
    ...
    SquadListResponse
    """ # noqa: E501
    squads: Optional[List[SquadResponse]] = None
    __properties: ClassVar[List[str]] = ["squads"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "squads": [SquadResponse.from_dict(_item) for _item in obj["squads"]] if obj.get("squads") is not None else None
        })
        return _obj
