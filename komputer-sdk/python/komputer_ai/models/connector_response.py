...
class ConnectorResponse(BaseModel):
    ...
    ConnectorResponse
    """ # noqa: E501
    agent_names: Optional[List[StrictStr]] = Field(default=None, alias="agentNames")
    attached_agents: Optional[StrictInt] = Field(default=None, alias="attachedAgents")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "agentNames": obj.get("agentNames"),
            "attachedAgents": obj.get("attachedAgents"),
