...
class PatchSquadRequest(BaseModel):
    """
    PatchSquadRequest
    """ # noqa: E501
    members: Optional[List[V1alpha1KomputerSquadMember]] = None
    orphan_ttl: Optional[StrictStr] = Field(default=None, alias="orphanTTL")
    __properties: ClassVar[List[str]] = ["members", "orphanTTL"]
