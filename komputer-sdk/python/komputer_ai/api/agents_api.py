...
class AgentsApi:
    ...
    @validate_call
    def compact_agent_task(
        self,
        name: Annotated[StrictStr, Field(description="Agent name")],
        namespace: Annotated[Optional[StrictStr], Field(description="Kubernetes namespace")] = None,
        request: Annotated[Optional[CompactAgentRequest], Field(description="Optional compaction instructions")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param namespace: Kubernetes namespace
        :type namespace: str
        :param request: Optional compaction instructions
        :type request: CompactAgentRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._compact_agent_task_serialize(
            name=name,
            namespace=namespace,
            request=request,
            _request_auth=_request_auth,
    ...
    @validate_call
    def compact_agent_task_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="Agent name")],
        namespace: Annotated[Optional[StrictStr], Field(description="Kubernetes namespace")] = None,
        request: Annotated[Optional[CompactAgentRequest], Field(description="Optional compaction instructions")] = None,
    ...
    @validate_call
    def compact_agent_task_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="Agent name")],
        namespace: Annotated[Optional[StrictStr], Field(description="Kubernetes namespace")] = None,
        request: Annotated[Optional[CompactAgentRequest], Field(description="Optional compaction instructions")] = None,
    ...
    def _compact_agent_task_serialize(
        self,
        name,
        namespace,
        request,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/agents/{name}/compact',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
