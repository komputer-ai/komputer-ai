...
class SchedulesApi:
    ...
    def trigger_schedule(
        ...
        _param = self._trigger_schedule_serialize(
            name=name,
            namespace=namespace,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def trigger_schedule_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="Schedule name")],
        namespace: Annotated[Optional[StrictStr], Field(description="Kubernetes namespace")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def trigger_schedule_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="Schedule name")],
        namespace: Annotated[Optional[StrictStr], Field(description="Kubernetes namespace")] = None,
        _request_timeout: Union[
    ...
    def _trigger_schedule_serialize(
        self,
        name,
        namespace,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/schedules/{name}/trigger',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
