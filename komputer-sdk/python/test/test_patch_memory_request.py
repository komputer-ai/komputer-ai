...
class TestPatchMemoryRequest(unittest.TestCase):
    """PatchMemoryRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatchMemoryRequest:
        """Test PatchMemoryRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchMemoryRequest`
        """
        model = PatchMemoryRequest()
        if include_optional:
    ...
    def testPatchMemoryRequest(self):
        """Test PatchMemoryRequest"""
