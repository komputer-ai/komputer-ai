...
type V1PodSpec struct {
	...
	DnsPolicy *V1DNSPolicy `json:"dnsPolicy,omitempty"`
	...
	PreemptionPolicy *V1PreemptionPolicy `json:"preemptionPolicy,omitempty"`
	...
	RestartPolicy *V1RestartPolicy `json:"restartPolicy,omitempty"`
	...
	WorkloadRef *V1WorkloadReference `json:"workloadRef,omitempty"`
}
...
// SetDnsPolicy gets a reference to the given V1DNSPolicy and assigns it to the DnsPolicy field.
...
// SetOverhead gets a reference to the given map[string]string and assigns it to the Overhead field.
...
// SetPreemptionPolicy gets a reference to the given V1PreemptionPolicy and assigns it to the PreemptionPolicy field.
...
// SetRestartPolicy gets a reference to the given V1RestartPolicy and assigns it to the RestartPolicy field.
...
// GetWorkloadRef returns the WorkloadRef field value if set, zero value otherwise.
func (o *V1PodSpec) GetWorkloadRef() V1WorkloadReference {
	if o == nil || IsNil(o.WorkloadRef) {
		var ret V1WorkloadReference
		return ret
	}
	return *o.WorkloadRef
}

// GetWorkloadRefOk returns a tuple with the WorkloadRef field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *V1PodSpec) GetWorkloadRefOk() (*V1WorkloadReference, bool) {
	if o == nil || IsNil(o.WorkloadRef) {
		return nil, false
	}
	return o.WorkloadRef, true
}
...
// SetWorkloadRef gets a reference to the given V1WorkloadReference and assigns it to the WorkloadRef field.
...
func (o V1PodSpec) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.WorkloadRef) {
		toSerialize["workloadRef"] = o.WorkloadRef
	}
