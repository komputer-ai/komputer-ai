...
`func (o *V1EmptyDirVolumeSource) GetMedium() V1StorageMedium`

GetMedium returns the Medium field if non-nil, zero value otherwise.

### GetMediumOk

`func (o *V1EmptyDirVolumeSource) GetMediumOk() (*V1StorageMedium, bool)`
...
`func (o *V1EmptyDirVolumeSource) SetMedium(v V1StorageMedium)`
