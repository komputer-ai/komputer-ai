...
// checks if the V1alpha1ScheduleAgentSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1alpha1ScheduleAgentSpec{}

// V1alpha1ScheduleAgentSpec struct for V1alpha1ScheduleAgentSpec
type V1alpha1ScheduleAgentSpec struct {
...
func NewV1alpha1ScheduleAgentSpec() *V1alpha1ScheduleAgentSpec {
	this := V1alpha1ScheduleAgentSpec{}
	return &this
}
...
func (o V1alpha1ScheduleAgentSpec) MarshalJSON() ([]byte, error) {
...
func (o V1alpha1ScheduleAgentSpec) ToMap() (map[string]interface{}, error) {
...
type NullableV1alpha1ScheduleAgentSpec struct {
	value *V1alpha1ScheduleAgentSpec
	isSet bool
}

func (v NullableV1alpha1ScheduleAgentSpec) Get() *V1alpha1ScheduleAgentSpec {
	return v.value
}

func (v *NullableV1alpha1ScheduleAgentSpec) Set(val *V1alpha1ScheduleAgentSpec) {
	v.value = val
	v.isSet = true
}

func (v NullableV1alpha1ScheduleAgentSpec) IsSet() bool {
	return v.isSet
}

func (v *NullableV1alpha1ScheduleAgentSpec) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV1alpha1ScheduleAgentSpec(val *V1alpha1ScheduleAgentSpec) *NullableV1alpha1ScheduleAgentSpec {
	return &NullableV1alpha1ScheduleAgentSpec{value: val, isSet: true}
}

func (v NullableV1alpha1ScheduleAgentSpec) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV1alpha1ScheduleAgentSpec) UnmarshalJSON(src []byte) error {
	v.isSet = true
